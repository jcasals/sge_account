...
<?php
	...
	include("$sge_path/DDBB_connection.php");
	include("$sge_path/DDBB_query.php");
	...
	<div class="container-fluid">
		<div class="row-fluid" id="top">
			...
			<center>
				...
				<?php
				if ($type == 'group') { echo '<a id="goback" class="pull-left" href="sge.php?period='.$period.'"><i class="icon-share-alt fliph"></i>Back</a>'; }
				?>
					<h4 id="title"><?php echo "$ttittle $tdate"; ?></h4>
					<small><i>Ok jobs means exit_status=0</i></small><br><br>
					...
					foreach ($query as $q) {
						if ($type == "group") {
							...
							$item = $q->groupname;
							$firstcol = "<a href='sge.php?type=group&groupname=$item&period=$period'>$item</a>";
						}
