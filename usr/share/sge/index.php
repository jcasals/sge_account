			...
			<div class="span12">
				<center>
	                <div class="well" id="wellt">
						<?php
							if ($type == 'g') { echo '<a id="goback" class="pull-left" href="index.php?period='.$period.'"><i class="icon-share-alt fliph"></i>Back</a>'; }
		                ?>
							...
							<?php
								...
								foreach ($query as $q) 
								{
									if ($type == "g") {
										...
										$item = $q->groupname;
										$firstcol = "<a href='index.php?type=g&groupname=$item&period=$period'>$item</a>";
									}
